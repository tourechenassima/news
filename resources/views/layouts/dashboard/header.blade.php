    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div id="notify_push" class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item text-center small text-gray-500" href="{{ route('admin.notifications.index') }}">Show All Notifications</a>
                @empty
                    <a class="dropdown-item text-center small text-gray-500" href="{{ route('admin.notifications.index') }}"> Not Notification </a>
                @endforelse
